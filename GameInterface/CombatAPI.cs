...
using Kingmaker.UnitLogic.Buffs.Components;  // WarhammerFreeUltimateBuff (IsTranscendPotentialAvailable)
...
using Kingmaker.Enums;                       // ★ v3.40.0: WeaponFamily (IsPlasmaWeapon)
